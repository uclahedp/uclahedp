...
Reads in any time-trace based dataset and just applies tdiode correction.
This simple program is intended to be compatible with any type of data read from
an oscilloscope source
"""
import numpy as np
import os
import h5py
...
def scopeRawToFull(src, dest, port=14, tdiode_hdf=None,
